...
# Should be in sync with org.gradle.internal.jvm.inspection.JvmVendor.
MAX_JVM_VERSION=21

# Find java
if [ -n "$JAVA_HOME" ] ; then
    if [ -x "$JAVA_HOME/jre/sh/java" ] ; then
        # IBM's JDK on AIX uses strange paths for the JVM
...
# Increase default memory limits for JVM execution
