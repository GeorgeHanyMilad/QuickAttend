...
import com.georgehany.quickattend.ui.theme.DarkBackground
import com.georgehany.quickattend.ui.theme.LightBackground
...
@Composable
private fun QuickAttendMainContent(
    ...
    LaunchedEffect(
        ...
        window?.let {
            ...
            it.statusBarColor = if (isDark) {
                DarkBackground.toArgb()
            } else {
                LightBackground.toArgb()
            }

            it.navigationBarColor = if (isDark) {
                DarkBackground.toArgb()
            } else {
                LightBackground.toArgb()
            }
